    ...
    <div className={styles.pageWrapper}>
      <div className={styles.header}>
        ...
        <div className={styles.headerSubtitle}>
          {isEdit ? "작품 정보를 수정하세요" : "새 작품을 등록하세요"}
        </div>
      </div>
        ...
        <div className={styles.formCard}>
            ...
            <div className={styles.genreGroup}>
              {genres.map((g) => (
                <button
                  key={g}
                  onClick={() => setGenre(g)}
                  className={`${styles.genreBtn} ${genre === g ? styles.genreBtnActive : ""}`}
                >
                  {g}
                </button>
              ))}
          ...
          <div className={styles.formGroup}>
            <div className={styles.formLabel}>
              연재 요일 <span className={styles.optional}>(복수 가능)</span>
            </div>
          ...
          <div className={styles.formGroup}>
            <div className={styles.formLabel}>
              홍보 영상 URL <span className={styles.optional}>(선택)</span>
            </div>
            <input
              value={videoUrl}
