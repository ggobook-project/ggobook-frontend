...
export default function NovelViewerPage() {
  ...
  const handleGenerateTts = async (voiceId) => {
    try {
      ...
      const infoRes = await api.get(
        `/api/episodes/${episodeId}/tts/chunk-info?voiceId=${voiceId}`,
      );
      ...
      if (!chunk0Url) {
        const res = await api.post(
          `/api/episodes/${episodeId}/tts/chunk/0?voiceId=${voiceId}`,
        );
  ...
  const goContentDetail = () => {
    ...
    else if (episode?.content?.contentId)
  ...
  const handleParallelUniverse = async () => {
    ...
    try {
      const response = await llmApi.post("/api/parallel-universe", {
        title: episode?.content?.title || "",
        summary: episode?.content?.summary || "",
        content_text: novel?.contentText || "",
        what_if: whatIf,
      });
      ...
      <div className={styles.content}>
        ...
        <div style={{ textAlign: "center", margin: "32px 0" }}>
          <button
            ...
            style={{
              background: "linear-gradient(135deg, #4CAF82, #2196F3)",
              color: "white",
              border: "none",
              borderRadius: 24,
              padding: "12px 28px",
        ...
        <div className={styles.bottomInner}>
          <div className={styles.ttsRow}>
            ...
            <span className={styles.timeLabel}>
              ...
              {totalChunks > 1 && (
                <span
                  style={{ marginLeft: 6, fontSize: "0.75em", opacity: 0.6 }}
                >
          ...
          <div className={styles.navRow}>
            <button
              ...
              onClick={() =>
                navigate(`/novel/viewer/${parseInt(episodeId) - 1}`)
              }
            >
              <svg
                width="18"
            ...
            <button className={styles.listBtn} onClick={goContentDetail}>
              목록
            </button>
            <button
                    ...
                    <div className={styles.moreMenu}>
                      {cm.isMine ? (
                        ...
                        <button
                          ...
                          onClick={() => {
                            handleReportClick(cm, "NOVEL_COMMENT");
                            setOpenMoreId(null);
                          }}
                        >
                          <svg
                    ...
                    <div className={styles.commentReactions}>
                      ...
                      >
                        <svg
                          ...
                          stroke={cm.myLike === "like" ? "#2196F3" : "#90A4C8"}
                          strokeWidth="1.8"
                          strokeLinecap="round"
                          strokeLinejoin="round"
                        >
                              ...
                              <div className={styles.moreMenu}>
                                {reply.isMine ? (
                                  ...
                                  <button
                                    className={`${styles.moreMenuItem} ${styles.moreMenuItemReport}`}
                                    onClick={() => {
                                      handleReportClick(reply, "NOVEL_REPLY");
                                      setOpenMoreReplyId(null);
                                    }}
                                  >
                                    <svg
                            ...
                            <div className={styles.commentBottomRow}>
                              ...
                              <div className={styles.commentReactions}>
                                ...
                                <button
                                  ...
                                  onClick={() =>
                                    handleReplyLike(cm.id, reply.id, "dislike")
                                  }
                                >
                                  <svg
                                    width="14"
            ...
            {!parallelResult ? (
              <>
                <textarea
                  ...
                  placeholder="예) 여주가 서브 남주를 선택했다면?"
                  rows={3}
                  style={{
                    width: "100%",
                ...
                <div style={{ display: "flex", gap: 8, marginTop: 12 }}>
                  ...
                  <button
                    onClick={handleParallelUniverse}
                    disabled={parallelLoading || !whatIf.trim()}
                    style={{
                      flex: 2,
                      padding: "10px",
                      background: "linear-gradient(135deg, #4CAF82, #2196F3)",
